...
import com.college.attendance.context.ApplicationContext;
import com.college.attendance.db.DBAdapter;
import com.example.collegeattendancesystem.R;
...
public class AddAttandanceSessionActivity<AddAttandanceActivity> extends Activity {
	...
	private String[] subjectFinal = new String[] {"M1","DS","M2","CN","ML","OS"};
